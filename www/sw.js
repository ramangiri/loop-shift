const CACHE = 'loop-shift-rhythm-16';
const FILES = ['./','./index.html','./style.css','./mobile.css','./arcade.woff','./challenge-picker.js','./game.js','./leaderboard.js','./music.js','./native-bridge.js','./apple-touch-icon.png','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
