const CACHE = 'loop-shift-checkpoint-actions-48';
const FILES = ['./','./index.html','./style.css','./mobile.css','./arcade.woff','./avatars.js','./challenge-picker.js','./events.css','./social.js','./result-tools.js','./game.js','./leaderboard.js','./music.js','./native-bridge.js','./apple-touch-icon.png','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
